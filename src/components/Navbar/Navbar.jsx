...
export function NavbarDefault() {
  ...
  return (
    <Navbar className="mx-auto max-w-screen-xl px-4 py-2 lg:px-8 lg:py-8">
      <div className="container mx-auto flex items-center justify-between text-blue-gray-900">
        ...
        >
         <div className="lg:text-4xl text-3xl bg-gradient-to-r from-stone-300 via-violet-600 to-teal-800 bg-clip-text text-transparent">
             Deepak Chhantyal
         </div>
        </Typography>
